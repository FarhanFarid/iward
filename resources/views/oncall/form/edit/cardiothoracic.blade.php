<div class="modal" id="updatect-modal" data-bs-backdrop="static" data-bs-keyboard="false" tabindex="-1" aria-labelledby="staticBackdropLabel" aria-hidden="true">
    <div class="modal-dialog modal-dialog-scrollable" style="max-width: 40% !important;">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <form id="updateoncallcardiothoracicform">
                    @csrf
                                            ...
                                            <div class="col-md-12">
                                                ...
                                                <div class="d-flex border">
                                                    <div class="col-md-8 p-2">
                                                        ...
                                                        <select class="form-select form-select-sm" data-control="select2" data-dropdown-parent="#updatect-modal" data-dropdown-parent="body" data-placeholder="Select an option" id="updatectstaff" name="updatectstaff">
                                                            <option></option>
                                                    ...
                                                    <div class="col-md-4 p-2">
                                                        ...
                                                        <input class="form-control form-control-sm" type="datetime-local" name="updatectoncalldate" id="updatectoncalldate" readonly>
                                                        <input class="form-control form-control-sm" type="hidden" name="occtid" id="occtid">
                                                    </div>
                                                </div>
                                            </div>
                                        </div>
            ...
            <div class="modal-footer">
                <button type="button" class="btn btn-primary btn-sm font-weight-bold update-occt mt-2">{{__('SAVE')}}</button>
